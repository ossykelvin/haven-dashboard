...
export const initialData: HavenData = {
  ...
  maintenanceTasks: [
    {
      id: 'MNT-9',
      title: 'Hoist LOLER inspection',
      category: 'Statutory',
      asset: 'Oxford Journey Hoist',
      owner: 'Daniel Hughes',
      dueDate: '2026-09-24',
      priority: 'High',
      status: 'Scheduled'
    ...
    {
      id: 'MNT-8',
      title: 'Fire panel weekly test',
      category: 'PPM',
      asset: 'Fire panel – addressable',
      owner: 'Daniel Hughes',
      dueDate: '2026-09-22',
      priority: 'Medium',
      status: 'In progress'
  ...
  risks: [
    {
      id: 'RSK-6',
      title: 'Night staffing shortfall',
      category: 'Workforce',
      likelihood: 'Medium',
      impact: 'High',
      level: 'High',
    ...
    {
      id: 'RSK-5',
      title: 'Falls in lounge circulation space',
      category: 'Clinical',
      likelihood: 'High',
      impact: 'Medium',
      level: 'High',
    ...
    {
      id: 'RSK-4',
      title: 'Kitchen fire door hold-open device',
      category: 'Fire',
      likelihood: 'Low',
      impact: 'High',
      level: 'Medium',
  ...
  documents: [
    ...
    {
      id: 'DOC-14',
      title: 'DBS and recruitment evidence pack',
      category: 'Evidence',
      kloe: 'Well-led',
      owner: 'Olivia Bennett',
